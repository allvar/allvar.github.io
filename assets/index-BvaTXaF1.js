 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,j){var M=z.length;z.push(j);e:for(;0<M;){var Z=M-1>>>1,ne=z[Z];if(0<o(ne,j))z[Z]=j,z[M]=ne,M=Z;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var j=z[0],M=z.pop();if(M!==j){z[0]=M;e:for(var Z=0,ne=z.length,zr=ne>>>1;Z<zr;){var Ot=2*(Z+1)-1,El=z[Ot],Rt=Ot+1,Pr=z[Rt];if(0>o(El,M))Rt<ne&&0>o(Pr,El)?(z[Z]=Pr,z[Rt]=M,Z=Rt):(z[Z]=El,z[Ot]=M,Z=Ot);else if(Rt<ne&&0>o(Pr,M))z[Z]=Pr,z[Rt]=M,Z=Rt;else break e}}return j}function o(z,j){var M=z.sortIndex-j.sortIndex;return M!==0?M:z.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],c=[],v=1,m=null,h=3,S=!1,w=!1,y=!1,T=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(z){for(var j=n(c);j!==null;){if(j.callback===null)r(c);else if(j.startTime<=z)r(c),j.sortIndex=j.expirationTime,t(a,j);else break;j=n(c)}}function p(z){if(y=!1,d(z),!w)if(n(a)!==null)w=!0,Cl(x);else{var j=n(c);j!==null&&kl(p,j.startTime-z)}}function x(z,j){w=!1,y&&(y=!1,f(P),P=-1),S=!0;var M=h;try{for(d(j),m=n(a);m!==null&&(!(m.expirationTime>j)||z&&!Le());){var Z=m.callback;if(typeof Z=="function"){m.callback=null,h=m.priorityLevel;var ne=Z(m.expirationTime<=j);j=e.unstable_now(),typeof ne=="function"?m.callback=ne:m===n(a)&&r(a),d(j)}else r(a);m=n(a)}if(m!==null)var zr=!0;else{var Ot=n(c);Ot!==null&&kl(p,Ot.startTime-j),zr=!1}return zr}finally{m=null,h=M,S=!1}}var _=!1,k=null,P=-1,D=5,I=-1;function Le(){return!(e.unstable_now()-I<D)}function Pn(){if(k!==null){var z=e.unstable_now();I=z;var j=!0;try{j=k(!0,z)}finally{j?Tn():(_=!1,k=null)}}else _=!1}var Tn;if(typeof u=="function")Tn=function(){u(Pn)};else if(typeof MessageChannel<"u"){var na=new MessageChannel,y0=na.port2;na.port1.onmessage=Pn,Tn=function(){y0.postMessage(null)}}else Tn=function(){T(Pn,0)};function Cl(z){k=z,_||(_=!0,Tn())}function kl(z,j){P=T(function(){z(e.unstable_now())},j)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){w||S||(w=!0,Cl(x))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(z){switch(h){case 1:case 2:case 3:var j=3;break;default:j=h}var M=h;h=j;try{return z()}finally{h=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,j){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var M=h;h=z;try{return j()}finally{h=M}},e.unstable_scheduleCallback=function(z,j,M){var Z=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?Z+M:Z):M=Z,z){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=M+ne,z={id:v++,callback:j,priorityLevel:z,startTime:M,expirationTime:ne,sortIndex:-1},M>Z?(z.sortIndex=M,t(c,z),n(a)===null&&z===n(c)&&(y?(f(P),P=-1):y=!0,kl(p,M-Z))):(z.sortIndex=ne,t(a,z),w||S||(w=!0,Cl(x))),z},e.unstable_shouldYield=Le,e.unstable_wrapCallback=function(z){var j=h;return function(){var M=h;h=j;try{return z.apply(this,arguments)}finally{h=M}}}})(Wu);Vu.exports=Wu;var B0=Vu.exports;/**
 * @license React
...
`;function Mm(e,t,n){switch(n){case"bottom-left":return t?xm:om;case"bottom-right":return t?Cm:lm;case"down":return e?t?Em:sm:t?km:im;case"left":return e?t?Lm:am:t?_m:ta;case"right":return e?t?zm:cm:t?Nm:um;case"top-left":return t?Pm:fm;case"top-right":return t?Tm:dm;case"up":return e?t?Im:mm:t?jm:pm;default:return t?Sm:rm}}const Om=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,l=L.useMemo(()=>Mm(t,r,n),[t,n,r]);return re(h0,{keyframes:l,...o})};E`
  from {
